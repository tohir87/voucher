                    ...
                    <div class="span12">
                        <div class="box box-bordered">
                            <div class="box-title">
                                ...
                                <a href="#new_w_metric" data-toggle="modal" class="btn btn-primary pull-right" style="margin-right: 10px">
                                    <i class="icons icon-plus-sign"></i> New Metric
                                </a>
                                <?php endif; ?>
                            </div>
                            <div class="box-content-padless">
                                <?php if (!empty($w_metrics)): ?>
                                            ...
                                            foreach ($w_metrics as $metric):
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#view_sub_category" data-toggle='modal' ng-click="showSubCategory('<?= $metric->metric_wholesale_id; ?>', 'metric_wholesale_category')">
                                                            view
                                                        </a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <?php if ($this->user_auth_lib->have_perm('setup:edit_metric')): ?>
                                                    <td>
                                                        <a class="edit_metric" href="<?= site_url('/setup/edit_metric/'.$metric->metric_wholesale_id . '/1')?>"> <i class="icons icon-edit"></i> Edit</a> | 
                                                        <a class="Toggle" data-enabled='<?= $metric->status ?>' href="<?= site_url('setup/deleteMetric/' . $metric->metric_wholesale_id) ?>" > <i class="icons icon-trash"></i> Delete </a> |
                                                        <a href="#new_w_metric_sub" data-toggle="modal" ng-click="addSubCategory('<?= $metric->metric_wholesale_id; ?>')"> Assign to Category</a>
