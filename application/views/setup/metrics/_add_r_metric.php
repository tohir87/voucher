<div class="modal hide fade modal-full" id="new_r_metric" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" >
...
<div class="modal hide fade" id="new_r_metric_sub" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" >
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h4 class="modal-title" id="myModalLabel">Add New Metric</h4>
    </div>

    <form name="frmadd" id="frmadd" method="post" action="<?= site_url('setup/metric_retail_category') ?>" class="form-horizontal form-bordered">
        <div class="modal-body nopadding">
            <div class="control-group" style="margin-left: 30px">
                ...
                <table class="table table-condensed table-striped table-bordered">
                    ...
                    <tbody>
                        <tr ng-repeat="sub in sub_categories">
                            ...
                            <?php if ($this->user_auth_lib->have_perm('setup:edit_metric')): ?>
                            <td><a href="<?= site_url('setup/deleteMetricRtSubCategory')?>/{{sub.metric_retail_category_id}}" class="DeleteSubCategory">delete</a></td>
                            <?php endif; ?>
                        </tr>
                    </tbody>
                </table>
